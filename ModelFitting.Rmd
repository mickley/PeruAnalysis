...
z.bi <- gtable_add_grob(z.bi,
                     list(rectGrob(gp = gpar(fill=NA, col=NA, lwd=0)),
                          textGrob("Relative conspecific clustering", rot = 90,
                                   gp = gpar(fontsize=12))),
                     t=6, l=2, b=12, r=2, name = paste(runif(2)))
...
z.bi <- gtable_add_grob(z.bi,
                     list(rectGrob(gp = gpar(fill='grey', col=NA, lwd=0.2)),
                          textGrob("Disperser sensitivity", rot = -90,
                                   gp = gpar(fontsize=12))),
                     t=8, l=9, b=10, r=9, name = paste(runif(2)))
ggdraw(z.bi)
...
if(clusterNiter >= 999){
  png(file='../../huntingpaper/figures/Figure2_uni.png', width=6, height=4, units='in', res=600)
  ggdraw(z.uni)
  dev.off()
  
  pdf(file='../../huntingpaper/figures/Figure2_uni.pdf', width=6, height=4)
  ggdraw(z.uni)
  dev.off()
