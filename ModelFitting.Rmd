...
load("../results/v7.0/Peru_v7_1_wayAnovaSaps_rmax15.RData")

load("../results/v7.0/Peru_v7_2_wayAnovaSaps_rmax15.RData")
...
anova.saps.uni <- c(anova.saps.uni.1way, "huntpres:HSD" = anovaSaps2$uni$anovas[[1]])

## bivariate
anova.saps.bi.1way <- 
  lapply(anovaSaps1$bi$anovas, function(x) x$dtable)
names(anova.saps.bi.1way) <- sapply(anovaSaps1$bi$anovas, function(x) x[[1]]$term)
anova.saps.bi <- c(anova.saps.bi.1way, "huntpres:HSD" = anovaSaps2$bi$anovas[[1]])
...
allform <- update(formula(intMod.bi[[1]]), NULL~.)
## Make model matrix
...
load("../results/v7.0/PeruDispersal_v7_rmax15.RData")
...
load("../results/v7.0/Peru_v73_wayAnovaJuvs_rmax15.RData")
