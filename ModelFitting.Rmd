...
if(!windsep)
{
  ...
  load("../results/v7.0/Peru_v7_2_wayAnovaJuvs_rmax15_nsim99.RData")
...
{
  load("../results/v7.0/Peru_v7_1_wayAnovaJuvs_rmax15_nsim99_NoAbiotic.RData")
  load("../results/v7.0/Peru_v7_2_wayAnovaJuvs_rmax15_nsim99_NoAbiotic.RData")
  load("../results/v7.0/Peru_v7_3_wayAnovaJuvs_rmax15_nsim999_NoAbiotic.RData")
...
intAnovaTable.bi <- do.call(what='abind', args=list(lapply(anova.int.bi, extractAnova), 
                                ...
                                new.names=list(NULL,
                                               paste(rep(names(anova.int.bi), each=2), 
                                                     rep(c('D', 'P'), 3), sep='_'),
                                               NULL)))
aperm(intAnovaTable.uni, c(2, 1, 3))
aperm(intAnovaTable.bi, c(2, 1,3))
