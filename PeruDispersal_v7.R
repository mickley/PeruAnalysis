...
hyperdat.uni  <- mapply(function(dat, sitenms)
{
...
## can ignore the warnings - they are just telling us that some species 
## were removed (which is what we were trying to figure out.
